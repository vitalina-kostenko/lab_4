...
class Program
{
    static void Main(string[] args)
    {
        ...
        TestOperations_1.TestAPlusBSquare(new MyFrac(1, 3), new MyFrac(1, 6));
        TestOperations_1.TestAPlusBSquare(new MyComplex(1, 3), new MyComplex(1, 6));

        TestOperations_2.TestSquaresDifference(new MyFrac(1, 3), new MyFrac(1, 6));
        TestOperations_2.TestSquaresDifference(new MyComplex(1, 3), new MyComplex(1, 6));
        Console.ReadKey();
    }
}
